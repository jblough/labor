...
public class ComparisonActivity extends Activity {
	...
	private void updateStats(final StatisticalSummary summary) {
		...
		updateLabel((TextView)findViewById(R.id.percentile_10th_value), (summary == null) ? null : summary.annual10thPercentileWage);
		updateLabel((TextView)findViewById(R.id.percentile_25th_value), (summary == null) ? null : summary.annual25thPercentileWage);
		updateLabel((TextView)findViewById(R.id.median_value), (summary == null) ? null : summary.annualMedianWage);
		updateLabel((TextView)findViewById(R.id.percentile_75th_value), (summary == null) ? null : summary.annual75thPercentileWage);
		updateLabel((TextView)findViewById(R.id.percentile_90th_value), (summary == null) ? null : summary.annual90thPercentileWage);

		findViewById(R.id.comparison_percentiles).setVisibility(View.VISIBLE);

		plotValues(summary);

		if (this.salary != null && summary != null) {
	...
	private void plotValues(final StatisticalSummary summary) {
		...
		plot.setDomainStepMode(XYStepMode.INCREMENT_BY_VAL);
		if (summary != null && !"-".equals(summary.annual10thPercentileWage) && summary.annual10thPercentileWage != null)
			plot.setRangeLowerBoundary(Integer.valueOf(summary.annual10thPercentileWage) - 5000, BoundaryMode.FIXED);
		else
			plot.setRangeLowerBoundary(0, BoundaryMode.FIXED);

		if (summary != null && !"-".equals(summary.annual90thPercentileWage) && summary.annual90thPercentileWage != null)
