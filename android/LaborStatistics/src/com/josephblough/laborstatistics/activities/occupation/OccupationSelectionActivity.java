...
public class OccupationSelectionActivity extends ListActivity implements OnItemSelectedListener, OnEditorActionListener, TextWatcher {
	...
	lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
		...
		Intent intent = new Intent(OccupationSelectionActivity.this, OccupationTabbedActivity.class);
	...
	List<OccupationDataset> occupations = 
		DataLibrary.getOccupations(OccupationSelectionActivity.this, ((OccupationGroupDataset)adapter.getItemAtPosition(position)));
	//setListAdapter(new ArrayAdapter<OccupationDataset>(OccupationSelectionActivity.this, android.R.layout.simple_list_item_1, occupations));
	setListAdapter(new ArrayAdapter<OccupationDataset>(OccupationSelectionActivity.this, R.layout.occupation_row, R.id.occupation_name, occupations));
    ...
    */
	...
	//Toast.makeText(this, R.string.occupation_selection_toolip, Toast.LENGTH_LONG).show();
        ...
        tooltipPanel.startAnimation(AnimationUtils.loadAnimation(OccupationSelectionActivity.this,
        	R.anim.slide_in));
