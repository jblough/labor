...
public class LocationOccupationDetailsActivity extends Activity {

    private static final String TAG = "LocationOccupationDetailsActivity";
    
    public static final String OCCUPATION_CODE = "LocationOccupationDetailsActivity.occupation_code";
	...
	if (nationalSummary == null) {
		...
		public void error(String error) {
		    ...
		    Toast.makeText(LocationOccupationDetailsActivity.this, error, Toast.LENGTH_LONG).show();
		}
	    });
	...
	//Toast.makeText(this, R.string.occupation_selection_toolip, Toast.LENGTH_LONG).show();
        if (tooltipPanel == null) {
            ...
            tooltipPanel.startAnimation(AnimationUtils.loadAnimation(LocationOccupationDetailsActivity.this,
        	    R.anim.slide_in));
        }
